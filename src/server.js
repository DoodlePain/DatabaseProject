...
var appoggio = require('./appoggio.json')
var fs = require('fs')
...
app.post('/Statistiche/insert', (req, res) => {
    ...
    console.log("('" + req.body.elo + "'," + req.body.livello + ",'" + req.body.lega + "'," + req.body.class_nazionale + "," + req.body.class_continentale + "," + req.body.partite_giocate + "," + req.body.partite_vinte + "," + req.body.partite_perse + "," + req.body.winrate + "),");
...
app.post('/Sponsor/insert', (req, res) => {
    ...
    console.log("(\"" + req.body.nome + "\",\"" + req.body.nazione + "\",\"" + req.body.ambito + "\",\"" + req.body.societa + "\"),");
...
app.post('/Staff/insert', (req, res) => {
    ...
    //console.log(query1);
    console.log("(\"" + req.body.ambito + "\",\"" + req.body.ruolo + "\"," + req.body.utente + "),");
...
app.post('/Organizzatori/insert', (req, res) => {
    ...
    //console.log(query1);
    console.log("(\"" + req.body.nome + "\",\"" + req.body.ambito + "\",\"" + req.body.societa + "\",\"" + req.body.nazione + "\",\"" + req.body.contatto + "\"," + req.body.verificato + "," + req.body.utente + "),");
...
app.post('/Torneo/insert', (req, res) => {
    ...
    //console.log(query1);
    console.log(" (\"" + req.body.nome + "\"," + req.body.slot + ", \"" + req.body.data_inizio + "\",\"" + req.body.data_fine + "\", " + req.body.FK_Organizzatore + "," + req.body.FK_Sponsor + "," + req.body.premio + "),");
...
app.post('/Squadra/insert', (req, res) => {
    ...
    //console.log(query1);
    console.log("(\"" + req.body.nome + "\"," + req.body.FK_Leader + "," + req.body.FK_Sponsor + "," + req.body.FK_Manager + "," + req.body.FK_Statistiche + "),");
...
app.post('/Componenti/insert', (req, res) => {
    //console.log("Random data insert into Organizzatori table request");
    var query1 = "insert into Componenti (FK_Squadra,FK_Utente) VALUES (" + req.body.FK_Squadra + "," + req.body.utente + ")"
    console.log("(" + req.body.FK_Squadra + "," + req.body.utente + "),");
...
app.post('/Iscrizione/insert', (req, res) => {
    ...
    console.log("(" + req.body.FK_Squadra + ", " + req.body.FK_Torneo + "),");
...
app.post('/Sottoscrizione/insert', (req, res) => {
    ...
    console.log("(\"" + req.body.data_inizio + "\",\"" + req.body.data_fine + "\"," + req.body.FK_Utente + "," + req.body.FK_Abbonamento + "),");
